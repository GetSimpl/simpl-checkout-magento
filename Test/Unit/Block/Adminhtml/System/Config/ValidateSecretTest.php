<?php
namespace Simpl\Checkout\Test\Unit\Block\Adminhtml\System\Config;
...
/**
 * @covers \Simpl\Checkout\Block\Adminhtml\System\Config\ValidateSecret
 */
class ValidateSecretTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Simpl\Checkout\Block\Adminhtml\System\Config\ValidateSecret
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        \Simpl\Checkout\Block\Adminhtml\System\Config\ValidateSecret::class,
            [
     ...
     * @return array
     */
    public function dataProviderForTestGetButtonHtml()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetButtonHtml
     */
    public function testGetButtonHtml(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetValidateUrl()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetValidateUrl
     */
    public function testGetValidateUrl(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetSecretId()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetSecretId
     */
    public function testGetSecretId(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
