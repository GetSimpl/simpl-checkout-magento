<?php
namespace Simpl\Checkout\Test\Unit\Model\Total\Pdf;
...
/**
 * @covers \Simpl\Checkout\Model\Total\Pdf\SimplAdditionalFields
 */
class SimplAdditionalFieldsTest extends TestCase
{
    ...
    /**
     * Mock ordersFactoryInstance
     *
     * @var \Magento\Tax\Model\ResourceModel\Sales\Order\Tax\Collection|PHPUnit\Framework\MockObject\MockObject
     */
    private $ordersFactoryInstance;

    /**
     * Mock ordersFactory
     *
     * @var \Magento\Tax\Model\ResourceModel\Sales\Order\Tax\CollectionFactory|PHPUnit\Framework\MockObject\MockObject
     */
     ...
     * Object to test
     *
     * @var \Simpl\Checkout\Model\Total\Pdf\SimplAdditionalFields
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        $this->taxCalculation = $this->createMock(\Magento\Tax\Model\Calculation::class);
        $this->ordersFactoryInstance = $this->createMock(\Magento\Tax\Model\ResourceModel\Sales\Order\Tax\Collection::class);
        $this->ordersFactory = $this->createMock(\Magento\Tax\Model\ResourceModel\Sales\Order\Tax\CollectionFactory::class);
        $this->ordersFactory->method('create')->willReturn($this->ordersFactoryInstance);
        $this->testObject = $this->objectManager->getObject(
        \Simpl\Checkout\Model\Total\Pdf\SimplAdditionalFields::class,
            [
                'taxHelper' => $this->taxHelper,
                'taxCalculation' => $this->taxCalculation,
                'ordersFactory' => $this->ordersFactory,
            ]
        );
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetTotalsForDisplay()
    {
        return [
            'Testcase 1' => [
    ...
    /**
     * @dataProvider dataProviderForTestGetTotalsForDisplay
     */
    public function testGetTotalsForDisplay(array $prerequisites, array $expectedResult)
    {
     ...
     * @return array
     */
    public function dataProviderForTestGetFullTaxInfo()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetFullTaxInfo
     */
    public function testGetFullTaxInfo(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestCanDisplay()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestCanDisplay
     */
    public function testCanDisplay(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetAmount()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetAmount
     */
    public function testGetAmount(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetTitleDescription()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetTitleDescription
     */
    public function testGetTitleDescription(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
