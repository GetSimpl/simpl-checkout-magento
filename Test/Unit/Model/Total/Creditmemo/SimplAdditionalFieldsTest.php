<?php
namespace Simpl\Checkout\Test\Unit\Model\Total\Creditmemo;
...
/**
 * @covers \Simpl\Checkout\Model\Total\Creditmemo\SimplAdditionalFields
 */
class SimplAdditionalFieldsTest extends TestCase
{
    /**
     * Mock data
     *
     ...
     * Object to test
     *
     * @var \Simpl\Checkout\Model\Total\Creditmemo\SimplAdditionalFields
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        \Simpl\Checkout\Model\Total\Creditmemo\SimplAdditionalFields::class
        );
    }
     ...
     * @return array
     */
    public function dataProviderForTestCollect()
    {
        return [
            'Testcase 1' => [
    ...
    /**
     * @dataProvider dataProviderForTestCollect
     */
    public function testCollect(array $prerequisites, array $expectedResult)
    {
     ...
     * @return array
     */
    public function dataProviderForTestProcessConfigArray()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestProcessConfigArray
     */
    public function testProcessConfigArray(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
